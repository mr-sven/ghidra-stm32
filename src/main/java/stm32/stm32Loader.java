...
public class stm32Loader extends AbstractLibrarySupportLoader {
	...
	private static final STM32MemRegion [] STM32MEM = {
		...
		new STM32MemRegion("TIM5",0x40000C00,0x400,true,true,false),
		new STM32MemRegion("TIM6",0x40001000,0x400,true,true,false),
		new STM32MemRegion("TIM7",0x40001400,0x400,true,true,false),
		new STM32MemRegion("TIM12",0x40001800,0x400,true,true,false),
		new STM32MemRegion("TIM13",0x40001C00,0x400,true,true,false),
		new STM32MemRegion("TIM14",0x40002000,0x400,true,true,false),
		new STM32MemRegion("RTC/BKP",0x40002800,0x400,true,true,false),
		new STM32MemRegion("WWDG",0x40002C00,0x400,true,true,false),
		new STM32MemRegion("IWDG",0x40003000,0x400,true,true,false),
		new STM32MemRegion("I2S2ext",0x40003400,0x400,true,true,false),
		new STM32MemRegion("SPI2/I2S2",0x40003800,0x400,true,true,false),
		new STM32MemRegion("SPI3/I2S3",0x40003C00,0x400,true,true,false),
		new STM32MemRegion("I2S3ext",0x40004000,0x400,true,true,false),
		new STM32MemRegion("USART2",0x40004400,0x400,true,true,false),
		new STM32MemRegion("USART3",0x40004800,0x400,true,true,false),
		new STM32MemRegion("UART4",0x40004C00,0x400,true,true,false),
		new STM32MemRegion("UART5",0x40005000,0x400,true,true,false),
		new STM32MemRegion("I2C1",0x40005400,0x400,true,true,false),
		new STM32MemRegion("I2C2",0x40005800,0x400,true,true,false),
		new STM32MemRegion("I2C3",0x40005C00,0x400,true,true,false),
		new STM32MemRegion("CAN1",0x40006400,0x400,true,true,false),
		new STM32MemRegion("CAN2",0x40006800,0x400,true,true,false),
		new STM32MemRegion("PWR",0x40007000,0x400,true,true,false),
		new STM32MemRegion("DAC",0x40007400,0x400,true,true,false),
		new STM32MemRegion("UART7",0x40007800,0x400,true,true,false),
		new STM32MemRegion("UART8",0x40007C00,0x400,true,true,false),
		new STM32MemRegion("TIM1",0x40010000,0x400,true,true,false),
		new STM32MemRegion("TIM8",0x40010400,0x400,true,true,false),
		new STM32MemRegion("USART1",0x40011000,0x400,true,true,false),
		new STM32MemRegion("USART6",0x40011400,0x400,true,true,false),
		new STM32MemRegion("ADC1/2/3",0x40012000,0x400,true,true,false),
		new STM32MemRegion("SDIO",0x40012C00,0x400,true,true,false),
		new STM32MemRegion("SPI1",0x40013000,0x400,true,true,false),
		new STM32MemRegion("SPI2",0x40013400,0x400,true,true,false),
		new STM32MemRegion("SYSCFG",0x40013800,0x400,true,true,false),
		new STM32MemRegion("EXTI",0x40013C00,0x400,true,true,false),
		new STM32MemRegion("TIM9",0x40014000,0x400,true,true,false),
		new STM32MemRegion("TIM10",0x40014400,0x400,true,true,false),
		new STM32MemRegion("TIM11",0x40014800,0x400,true,true,false),
		new STM32MemRegion("SPI5",0x40015000,0x400,true,true,false),
		new STM32MemRegion("SPI6",0x40015400,0x400,true,true,false),
		new STM32MemRegion("SAI1",0x40015800,0x400,true,true,false),
		new STM32MemRegion("LCD TFT",0x40016800,0x400,true,true,false),
		new STM32MemRegion("GPIOA",0x40020000,0x400,true,true,false),
		new STM32MemRegion("GPIOB",0x40020400,0x400,true,true,false),
		new STM32MemRegion("GPIOC",0x40020800,0x400,true,true,false),
		new STM32MemRegion("GPIOD",0x40020c00,0x400,true,true,false),
		new STM32MemRegion("GPIOE",0x40021000,0x400,true,true,false),
		new STM32MemRegion("GPIOF",0x40021400,0x400,true,true,false),
		new STM32MemRegion("GPIOG",0x40021800,0x400,true,true,false),
		new STM32MemRegion("GPIOH",0x40021c00,0x400,true,true,false),
		new STM32MemRegion("GPIOI",0x40022000,0x400,true,true,false),
		new STM32MemRegion("GPIOJ",0x40022400,0x400,true,true,false),
		new STM32MemRegion("GPIOK",0x40022800,0x400,true,true,false),
		new STM32MemRegion("CRC",0x40023000,0x400,true,true,false),
		new STM32MemRegion("RCC",0x40023800,0x400,true,true,false),
		new STM32MemRegion("Flash Interface Register",0x40023C00,0x400,true,true,false),
		new STM32MemRegion("BKPSRAM",0x40024000,0x400,true,true,false),
		new STM32MemRegion("DMA1",0x40026000,0x400,true,true,false),
		new STM32MemRegion("DMA2",0x40026400,0x400,true,true,false),
		new STM32MemRegion("Ethernet Mac",0x40028000,0x1400,true,true,false),
		new STM32MemRegion("DMA2D",0x4002b000,0xc00,true,true,false),
		new STM32MemRegion("USB OTG HS",0x40040000,0x40000,true,true,false),
		new STM32MemRegion("USB OTG FS",0x50000000,0x40000,true,true,false),
		new STM32MemRegion("DCMI",0x50050000,0x400,true,true,false),
		new STM32MemRegion("CRYP",0x50060000,0x400,true,true,false),
		new STM32MemRegion("HASH",0x50060400,0x400,true,true,false),
		new STM32MemRegion("RNG",0x50060800,0x400,true,true,false),
		new STM32MemRegion("FSMC Control Register",0xA0000000,0x1000,true,true,false),
		new STM32MemRegion("SRAM",0x20000000,0x30000,true,true,true),
		new STM32MemRegion("System Memory",0x1FFF0000,0x7A10,true,true,true),
		new STM32MemRegion("Option Bytes 2",0x1FFFC000,0x09,true,false,false),
		new STM32MemRegion("Option Bytes 1",0x1FFEC000,0x09,true,false,false),
		new STM32MemRegion("CCM RAM",0x10000000,0x10000,true,true,true),
	};
	@Override
